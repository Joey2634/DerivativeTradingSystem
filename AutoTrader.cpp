...
// 配置参数
char  FRONT_ADDR_1A[] = "tcp://27.115.97.3:26205";		// 前置地址1交易:实盘
char  FRONT_ADDR_1B[] = "tcp://27.115.97.3:26213";		// 前置地址2行情:实盘
...
TThostFtdcBrokerIDType	BROKER_ID = "1011";								// 实盘：经纪公司代码 国泰君安=7090
TThostFtdcInvestorIDType INVESTOR_ID = "00000089";						// 实盘：投资者代码
...
TThostFtdcInstrumentIDType INSTRUMENT_ID = "IF1407";					// 交易合约代码
...
char *ppInstrumentID[] = {"IF1407"};									// 行情订阅列表
int iInstrumentID = 1;													// 行情订阅数量

bool	RunMode=1;														// 实盘下单=1,否则=0；  影响Common.h中的SendOrder()函数
